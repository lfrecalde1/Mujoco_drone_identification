...
set(gcf, 'PaperPosition', [0 0 10 4]);
subplot(4,1,1)
plot(t(1:length(ul_ref)),ty(1,1:length(t)),'-','Color',[226,76,44]/255,'linewidth',1); hold on
grid on;
...
subplot(4,1,2)
plot(t(1:length(ul_ref)),tx(1,1:length(t)),'-','Color',[46,188,89]/255,'linewidth',1); hold on
grid on;
